...
public class BasinTileEntity extends SmartTileEntity implements ITickableTileEntity {
	...
	protected LazyOptional<CombinedFluidHandler> fluidInventory = LazyOptional.of(() -> new CombinedFluidHandler(9, 1000));
	...
	public void read(CompoundNBT compound) {
		...
		if(compound.hasUniqueId("fluids"))
			fluidInventory.ifPresent(combinedFluidHandler -> combinedFluidHandler.readFromNBT(compound.getList("fluids", 10)));
	}
